...
{   boost::array<double, 36> odom_pose_covariance = {
    ...
    ********************************************************/
    bool robot::task_start(double V_x, double V_y,double V_w)
    {
        ...
        readSpeed(V_y_Actual, V_x_Actual, V_w_Actual, yaw);//速度接收CM/S  角度为100倍  单位 度
        V_y_Actual = -V_y_Actual;
        //V_x_Actual = 0;
        //V_y_Actual = 0;
        //V_w_Actual = 0;
        //yaw = 0;
